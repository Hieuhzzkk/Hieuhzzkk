        ...
        <div class="row">
            <div class="row mt-2">
                <article class="col-12 col-md-12 row center">
					...
					<h1>Gio Hang</h1>
					<a href="/truyen/home" type="button" class="btn btn-primary col-1 m-2">Back</a>
					<table border=1>
			            <thead>
			                <tr>
			                    <th>Truyen Id</th>
			            ...
			            <tbody>
			                ...
			                <c:forEach items="${cart}" var="cartDetail">
				                <form action="/shop/update" method="POST">
				                	<input type="hidden" name="id" value="${cartDetail.truyenId }"/>
				                	
				                	
					                	<tr>
					                        <td>${cartDetail.truyenId}</td>
					                        <td>${cartDetail.tenTruyen}</td>			                      	
					                  		<td>
						                  		<input name="soLuong" value="${cartDetail.soLuong}"
						                  		 onblur="this.form.submit()" style="width:50px"/>
					                  		</td>
					                  		<td>${cartDetail.gia}</td>
					                        <td>${cartDetail.gia*cartDetail.soLuong}</td>
					                        <td>
					                        	<a class="btn btn-primary" href="/shop/delete/${cartDetail.truyenId}">Xoa</a>
					                        </td>
					                    </tr>
				                </form>   
			                </c:forEach>
			        ...
			        <p>Tong Tien:${TOTAL}</p>
			        <hr/>
			        <a class="btn btn-primary btn-sm col-1 m-2" href="/shop/clear">Clear Cart</a> 
					<a class="btn btn-primary btn-sm col-1 m-2" href="/truyen/home">Add more</a>
					<a class="btn btn-primary btn-sm col-1 m-2" href="/order/checkout">Buy</a>
