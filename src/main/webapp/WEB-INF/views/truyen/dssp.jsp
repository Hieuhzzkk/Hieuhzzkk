        ...
        <div class="row">
            <div class="row mt-2">
                <article class="col-12 col-md-12 row center">
				    <form class="d-flex" action="/truyen/search">
						<label for="exampleDataList"  class="form-label">Tim Kiem</label>
						<input class="form-control" type="search" id="theloai" name="theloai" placeholder="Type to search..."/>
						<button type="submit" class="btn btn-primary m-2" >Tim</button>
					</form>
					...
					<table class="table">
					  ...
					  <tbody>
					  	<c:forEach items="${truyen.getContent()}" var="truyen">
						  	<tr>
						      <td>${ truyen.truyenId }</td>
						      <td>${ truyen.tenTruyen }</td>
						      <td>${ truyen.theLoai }</td>
						      <td>${ truyen.soTap }</td>
						      <td>${ truyen.soLuong }</td>
						      <td>${ truyen.gia }</td>
						      <td>
										<a class="btn btn-primary" href="/truyen/edit/${truyen.truyenId }">Cập nhật</a>
							  </td>
							  <td>
										<a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal${truyen.truyenId}" href="/truyen/delete?id=${truyen.truyenId }">Xóa</a>
										<div class="modal fade" id="exampleModal${truyen.truyenId}" tabindex="-1" aria-labelledby="exampleModalLabel${truyen.truyenId}" aria-hidden="true">
											  <div class="modal-dialog">
											    <div class="modal-content">
											      <div class="modal-header">
											        <h5 class="modal-title" id="exampleModalLabel${truyen.truyenId}">Modal title</h5>
											      ...
											      <div class="modal-footer">
											        ...
											        <a  class="btn btn-danger" href="/truyen/delete?id=${truyen.truyenId }">Xóa</a>
											      </div>
											    </div>
											  </div>
											</div>
						...
						<p class="center">
				        	<c:if test="${truyen.getNumber() > 0 }">
				        		<a href="/truyen?pageNumber=${truyen.getNumber() - 1}">Previous</a>
				        	</c:if>
				        	${ truyen.getNumber() + 1} / ${truyen.getTotalPages() }
				        	<a href="/truyen?pageNumber=${truyen.getNumber() + 1}">Next</a>
				        </p>
				    <div class="row">
				    	<a class="btn btn-primary col-1 m-2" href="/truyen/new" type="button">Them moi</a>
						<a class="btn btn-primary col-1 m-2" href="/shop/cart" type="button">Gio hang</a>
				    </div>
