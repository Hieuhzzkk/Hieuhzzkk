            ...
            <div class="row mt-2">
                <article class="col-12 col-md-12 row center">
                    <form class="d-flex" action="/truyen/search">
						...
						<button type="submit" class="btn btn-primary mt-2" >Tim</button>
					</form>
					<table class="table">
					  <thead>
					    <tr>
					  ...
					  <tbody>
					  	<c:forEach items="${truyensearch}" var="truyen">
						  	<tr>
					...
					<a class="btn btn-primary" href="/truyen/new" type="button">Them moi</a>
                </article>
