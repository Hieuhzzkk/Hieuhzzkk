        ...
        <div class="row">
            <div class="row mt-2">
                <article class="col-12 col-md-12 row center">
                    <h1>Them Truyen Moi</h1>
						<form:form action="/truyen/new" method="POST" modelAttribute="truyen">
							<div class="mb-3">
							...
							<button type="submit" class="btn btn-primary mt-2 col-1 m-2">Them Moi</button>
