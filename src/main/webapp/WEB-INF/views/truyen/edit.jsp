        ...
        <div class="row">
            <div class="row mt-2">
                <article class="col-12 col-md-12 row center">
                   <h1>Update Truyen</h1>
						<form:form action="/truyen/update" method="POST" modelAttribute="truyen">
							<div class="mb-3">
							  <form:label path="truyenId">ID Truyen</form:label>
							  <form:input path="truyenId" readonly="true" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<div class="mb-3">
							  <form:label path="tenTruyen">Ten Truyen</form:label>
							  <form:input path="tenTruyen" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<div class="mb-3">
							  <form:label path="theLoai">The Loai</form:label>
							  <form:input path="theLoai" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<div class="mb-3">
							  <form:label path="soTap">So Tap</form:label>
							  <form:input path="soTap" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<div class="mb-3">
							  <form:label path="soLuong">So Luong</form:label>
							  <form:input path="soLuong" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<div class="mb-3">
							  <form:label path="gia">Gia</form:label>
							  <form:input path="gia" type="text" class="form-control" id="exampleFormControlInput1"/>
							</div>
							<button type="submit" class="btn btn-primary mt-2">Sua</button>
